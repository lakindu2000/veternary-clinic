...
<body>
    <div class="navbar">
        <div class="admin-info">
            ...
            <span class="admin-name-nav"><?= htmlspecialchars($user['name'] ?? 'Admin') ?></span>
        </div>
    </div>
            ...
            <div class="profile-container">
                ...
                <div class="profile-section">
                    <div class="profile-header">
                        ...
                        <h2 class="user-name"><?= htmlspecialchars($user['email'] ?? 'User') ?></h2>
                        <span class="user-role badge bg-primary"><?= htmlspecialchars(ucfirst($user['role'] ?? 'user')) ?></span>
                    </div>
                    ...
                    <div class="profile-details">
                        ...
                        <div class="detail-row">
                            ...
                            <div class="detail-value"><?= htmlspecialchars(ucfirst($user['role'] ?? 'user')) ?></div>
                        </div>
                        <div class="detail-row">
